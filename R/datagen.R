...
#' - \eqn{X_i ~ i.i.d Bernoulli(n, p = 0.5)}
#' - \eqn{M_{i,k} = alpha_k X_i + e{1_{i,k}}}, where \eqn{e{1_{i,k}} ~ i.i.d N(0, 1), k = 1, ..., K}
#' - \eqn{Y_i = X_i + sum_k b_{i,k} M_{i,k} + e{2_{i,k}}}, where \eqn{e{2_{i,k}} ~ i.i.d. N(0, 1)}
